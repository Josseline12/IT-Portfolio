...
Before terminating the patch panel end of the cable, I looked at the color-coded wiring diagram printed on the back of the patch panel. The panel included markings for both the T568A and T568B wiring standards and like my previous labs, I followed the T568B markings.
...
Once I had enough working length, I routed the pairs to their corresponding terminals while keeping as much of each pair twisted as possible. I only separated the conductors where necessary to position them into the IDC slots.
After positioning all eight conductors, I was ready to punch them down.

### 4. Punching Down the Conductors

Once I had the conductors in the correct positions, I used a 110 punchdown tool to secure them into the patch panel's IDC terminals. I positioned the CUT side of the punchdown blade toward the excess end of each conductor. This allowed the tool to push the conductor into the IDC terminal while cutting off the excess wire on the outside of the termination. I worked through the conductors one at a time until all eight were seated and all the excess wires had been trimmed and removed.
...
Keeping the cable runs organized is important in a larger network because a network technician may eventually need to identify, troubleshoot, or replace on a specific cable run. Having proper cable management can make it easier to trace a cable back to its corresponding patch panel port and work on an individual run without having to sort through an unorganized group of cables.
...
Some of the things I learned during this project were:
  ...
  - How organizing multiple cable runs can make it easier to identify and troubleshoot a faulty connection.
